...
type ClientService interface {
	GetAgreementReports(params *GetAgreementReportsParams, authInfo runtime.ClientAuthInfoWriter) (*GetAgreementReportsOK, error)
...
func (a *Client) GetAgreementReports(params *GetAgreementReportsParams, authInfo runtime.ClientAuthInfoWriter) (*GetAgreementReportsOK, error) {
	...
	if params == nil {
		params = NewGetAgreementReportsParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "GetAgreementReports",
		Method:             "GET",
		PathPattern:        "/api/v1/AgreementReports/{productContainerId}",
		ProducesMediaTypes: []string{"application/json", "text/json", "text/plain"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetAgreementReportsReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetAgreementReportsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetAgreementReports: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
