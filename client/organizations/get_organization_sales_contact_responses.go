...
func (o *GetOrganizationSalesContactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetOrganizationSalesContactOK()
...
func NewGetOrganizationSalesContactOK() *GetOrganizationSalesContactOK {
	return &GetOrganizationSalesContactOK{}
}
...
func (o *GetOrganizationSalesContactOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/Organizations/{organizationId}/salescontact][%d] getOrganizationSalesContactOK  %+v", 200, o.Payload)
}
...
func (o *GetOrganizationSalesContactOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.OrganizationSalesContact)
