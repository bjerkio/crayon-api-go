...
// NewDeleteClientsParams creates a new DeleteClientsParams object
// with the default values initialized.
func NewDeleteClientsParams() *DeleteClientsParams {
	var ()
	return &DeleteClientsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteClientsParamsWithTimeout creates a new DeleteClientsParams object
...
// NewDeleteClientsParamsWithContext creates a new DeleteClientsParams object
...
// NewDeleteClientsParamsWithHTTPClient creates a new DeleteClientsParams object
...
/*DeleteClientsParams contains all the parameters to send to the API endpoint
for the delete clients operation typically these are written to a http.Request
*/
