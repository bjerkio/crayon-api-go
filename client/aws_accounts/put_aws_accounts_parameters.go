...
// NewPutAwsAccountsParams creates a new PutAwsAccountsParams object
// with the default values initialized.
func NewPutAwsAccountsParams() *PutAwsAccountsParams {
	var ()
	return &PutAwsAccountsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutAwsAccountsParamsWithTimeout creates a new PutAwsAccountsParams object
...
// NewPutAwsAccountsParamsWithContext creates a new PutAwsAccountsParams object
...
// NewPutAwsAccountsParamsWithHTTPClient creates a new PutAwsAccountsParams object
...
/*PutAwsAccountsParams contains all the parameters to send to the API endpoint
for the put aws accounts operation typically these are written to a http.Request
*/
type PutAwsAccountsParams struct {
