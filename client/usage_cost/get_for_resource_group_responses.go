...
func (o *GetForResourceGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetForResourceGroupOK()
...
func (o *GetForResourceGroupOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/UsageCost/resellerCustomer/{resellerCustomerId}/subscription/{subscriptionId}/resourceGroup/{resourceGroup}/currency/{currencyCode}][%d] getForResourceGroupOK  %+v", 200, o.Payload)
}
...
func (o *GetForResourceGroupOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
