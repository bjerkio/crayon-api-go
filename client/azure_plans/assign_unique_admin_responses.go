...
func (o *AssignUniqueAdminOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/AzurePlans/{azurePlanId}/azureSubscriptions/{id}/assign-unique-admin][%d] assignUniqueAdminOK  %+v", 200, o.Payload)
}
...
func (o *AssignUniqueAdminOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
