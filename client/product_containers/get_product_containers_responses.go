...
func (o *GetProductContainersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetProductContainersOK()
...
func (o *GetProductContainersOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/ProductContainers][%d] getProductContainersOK  %+v", 200, o.Payload)
}
...
func (o *GetProductContainersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.APICollectionOfProductContainer)
