...
func (o *GetCrayonAccountsOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/CrayonAccounts][%d] getCrayonAccountsOK  %+v", 200, o.Payload)
}

func (o *GetCrayonAccountsOK) GetPayload() *models.APICollectionOfCrayonAccount {
	return o.Payload
}

func (o *GetCrayonAccountsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.APICollectionOfCrayonAccount)
