...
func (o *UpdateCrayonAccountsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateCrayonAccountsOK()
...
func (o *UpdateCrayonAccountsOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/CrayonAccounts/{id}][%d] updateCrayonAccountsOK  %+v", 200, o.Payload)
}
...
func (o *UpdateCrayonAccountsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
