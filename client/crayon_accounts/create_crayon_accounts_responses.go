...
func (o *CreateCrayonAccountsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateCrayonAccountsOK()
...
func (o *CreateCrayonAccountsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/CrayonAccounts][%d] createCrayonAccountsOK  %+v", 200, o.Payload)
}
...
func (o *CreateCrayonAccountsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
