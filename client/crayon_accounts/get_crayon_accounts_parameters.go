...
// NewGetCrayonAccountsParams creates a new GetCrayonAccountsParams object
// with the default values initialized.
func NewGetCrayonAccountsParams() *GetCrayonAccountsParams {
	var ()
	return &GetCrayonAccountsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetCrayonAccountsParamsWithTimeout creates a new GetCrayonAccountsParams object
...
// NewGetCrayonAccountsParamsWithContext creates a new GetCrayonAccountsParams object
...
// NewGetCrayonAccountsParamsWithHTTPClient creates a new GetCrayonAccountsParams object
...
for the get crayon accounts operation typically these are written to a http.Request
*/
...
func (o *GetCrayonAccountsParams) WithTimeout(timeout time.Duration) *GetCrayonAccountsParams {
...
func (o *GetCrayonAccountsParams) WithContext(ctx context.Context) *GetCrayonAccountsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetCrayonAccountsParams) WithPage(page *int32) *GetCrayonAccountsParams {
	o.SetPage(page)
	return o
}
