...
func (o *GetCrayonAccountByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCrayonAccountByIDOK()
...
func (o *GetCrayonAccountByIDOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/CrayonAccounts/{id}][%d] getCrayonAccountByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetCrayonAccountByIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
