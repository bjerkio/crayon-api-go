...
// WithSubscription adds the subscription to the post subscriptions params
func (o *PostSubscriptionsParams) WithSubscription(subscription *models.SubscriptionDetailed) *PostSubscriptionsParams {
	o.SetSubscription(subscription)
	return o
}

// SetSubscription adds the subscription to the post subscriptions params
func (o *PostSubscriptionsParams) SetSubscription(subscription *models.SubscriptionDetailed) {
