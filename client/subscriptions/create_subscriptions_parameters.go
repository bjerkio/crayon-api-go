...
for the create subscriptions operation typically these are written to a http.Request
*/
...
func (o *CreateSubscriptionsParams) WithSubscription(subscription *models.SubscriptionDetailed) *CreateSubscriptionsParams {
