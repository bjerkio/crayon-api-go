...
/*PostSubscriptionsOK handles this case with default header values.
...
func (o *PostSubscriptionsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/Subscriptions][%d] postSubscriptionsOK  %+v", 200, o.Payload)
}

func (o *PostSubscriptionsOK) GetPayload() *models.SubscriptionDetailed {
	return o.Payload
}
