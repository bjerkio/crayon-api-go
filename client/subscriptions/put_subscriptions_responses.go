...
/*PutSubscriptionsOK handles this case with default header values.
...
func (o *PutSubscriptionsOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/Subscriptions/{id}][%d] putSubscriptionsOK  %+v", 200, o.Payload)
}

func (o *PutSubscriptionsOK) GetPayload() *models.SubscriptionDetailed {
	return o.Payload
}
