...
func (o *SubscriptionOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/Subscriptions/{id}][%d] subscriptionOK  %+v", 200, o.Payload)
}
...
func (o *SubscriptionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
