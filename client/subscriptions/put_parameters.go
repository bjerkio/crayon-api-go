...
// WithID adds the id to the put params
func (o *PutParams) WithID(id int32) *PutParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the put params
func (o *PutParams) SetID(id int32) {
	o.ID = id
}

// WithSubscription adds the subscription to the put params
func (o *PutParams) WithSubscription(subscription *models.SubscriptionDetailed) *PutParams {
	o.SetSubscription(subscription)
	return o
}

// SetSubscription adds the subscription to the put params
func (o *PutParams) SetSubscription(subscription *models.SubscriptionDetailed) {
