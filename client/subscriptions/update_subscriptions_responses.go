...
func (o *UpdateSubscriptionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateSubscriptionsOK()
...
func (o *UpdateSubscriptionsOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/Subscriptions/{id}][%d] updateSubscriptionsOK  %+v", 200, o.Payload)
}

func (o *UpdateSubscriptionsOK) GetPayload() *models.SubscriptionDetailed {
	return o.Payload
}

func (o *UpdateSubscriptionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
