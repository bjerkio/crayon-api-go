...
func (o *SetSubscriptionTagsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSetSubscriptionTagsOK()
...
func (o *SetSubscriptionTagsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/Subscriptions/{subscriptionId}/tags][%d] setSubscriptionTagsOK  %+v", 200, o.Payload)
}
...
func (o *SetSubscriptionTagsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
