...
func (o *GetActivationLinkAsyncReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetActivationLinkAsyncOK()
...
func NewGetActivationLinkAsyncOK() *GetActivationLinkAsyncOK {
	return &GetActivationLinkAsyncOK{}
}
...
func (o *GetActivationLinkAsyncOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/Subscriptions/{id}/activationlink][%d] getActivationLinkAsyncOK  %+v", 200, o.Payload)
}
...
func (o *GetActivationLinkAsyncOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ActivationLink)
