...
func (o *CreateSubscriptionsOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/Subscriptions][%d] createSubscriptionsOK  %+v", 200, o.Payload)
}

func (o *CreateSubscriptionsOK) GetPayload() *models.SubscriptionDetailed {
	return o.Payload
}
