...
// NewGetConsumerByIDParams creates a new GetConsumerByIDParams object
// with the default values initialized.
func NewGetConsumerByIDParams() *GetConsumerByIDParams {
	var ()
	return &GetConsumerByIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetConsumerByIDParamsWithTimeout creates a new GetConsumerByIDParams object
...
// NewGetConsumerByIDParamsWithContext creates a new GetConsumerByIDParams object
...
// NewGetConsumerByIDParamsWithHTTPClient creates a new GetConsumerByIDParams object
...
for the get consumer by Id operation typically these are written to a http.Request
*/
...
func (o *GetConsumerByIDParams) WithContext(ctx context.Context) *GetConsumerByIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetConsumerByIDParams) WithID(id int32) *GetConsumerByIDParams {
	o.SetID(id)
	return o
}
