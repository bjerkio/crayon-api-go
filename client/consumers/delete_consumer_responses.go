...
func (o *DeleteConsumerOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/Consumers/{id}][%d] deleteConsumerOK  %+v", 200, o.Payload)
}
...
func (o *DeleteConsumerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
