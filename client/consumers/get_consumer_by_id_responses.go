...
func (o *GetConsumerByIDOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/Consumers/{id}][%d] getConsumerByIdOK  %+v", 200, o.Payload)
}
...
func (o *GetConsumerByIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
