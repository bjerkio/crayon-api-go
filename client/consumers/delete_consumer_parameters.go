...
// NewDeleteConsumerParams creates a new DeleteConsumerParams object
// with the default values initialized.
func NewDeleteConsumerParams() *DeleteConsumerParams {
	var ()
	return &DeleteConsumerParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteConsumerParamsWithTimeout creates a new DeleteConsumerParams object
...
// NewDeleteConsumerParamsWithContext creates a new DeleteConsumerParams object
...
// NewDeleteConsumerParamsWithHTTPClient creates a new DeleteConsumerParams object
...
for the delete consumer operation typically these are written to a http.Request
*/
...
func (o *DeleteConsumerParams) WithContext(ctx context.Context) *DeleteConsumerParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteConsumerParams) WithID(id int32) *DeleteConsumerParams {
	o.SetID(id)
	return o
}
