...
func (o *AddConsumerOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/Consumers][%d] addConsumerOK  %+v", 200, o.Payload)
}
...
func (o *AddConsumerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
