...
func (o *DeleteGroupingsOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/Groupings/{id}][%d] deleteGroupingsOK ", 200)
}

func (o *DeleteGroupingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
