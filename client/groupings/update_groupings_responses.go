...
Success
*/
type UpdateGroupingsOK struct {
	Payload *models.Grouping
}

func (o *UpdateGroupingsOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/Groupings/{id}][%d] updateGroupingsOK  %+v", 200, o.Payload)
}
...
func (o *UpdateGroupingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
