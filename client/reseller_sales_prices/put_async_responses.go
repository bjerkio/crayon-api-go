...
func (o *PutAsyncOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/ResellerSalesPrices/{oldFromDate}][%d] putAsyncOK  %+v", 200, o.Payload)
}
...
func (o *PutAsyncOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
