...
func (o *DeleteByFilterAsyncReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteByFilterAsyncOK()
...
func (o *DeleteByFilterAsyncOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/ResellerSalesPrices][%d] deleteByFilterAsyncOK ", 200)
}

func (o *DeleteByFilterAsyncOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
