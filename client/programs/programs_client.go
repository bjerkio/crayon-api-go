...
type ClientService interface {
	GetPrograms(params *GetProgramsParams, authInfo runtime.ClientAuthInfoWriter) (*GetProgramsOK, error)
...
func (a *Client) GetPrograms(params *GetProgramsParams, authInfo runtime.ClientAuthInfoWriter) (*GetProgramsOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for GetPrograms: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
