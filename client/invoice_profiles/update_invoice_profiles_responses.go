...
func (o *UpdateInvoiceProfilesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateInvoiceProfilesOK()
...
func NewUpdateInvoiceProfilesOK() *UpdateInvoiceProfilesOK {
	return &UpdateInvoiceProfilesOK{}
}
...
func (o *UpdateInvoiceProfilesOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/InvoiceProfiles/{id}][%d] updateInvoiceProfilesOK  %+v", 200, o.Payload)
}
...
func (o *UpdateInvoiceProfilesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
