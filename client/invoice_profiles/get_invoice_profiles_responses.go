...
func (o *GetInvoiceProfilesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetInvoiceProfilesOK()
...
func (o *GetInvoiceProfilesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/InvoiceProfiles][%d] getInvoiceProfilesOK  %+v", 200, o.Payload)
}
...
func (o *GetInvoiceProfilesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.APICollectionOfInvoiceProfile)
