...
func (o *VerifyAsyncOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/Assets/verify][%d] verifyAsyncOK  %+v", 200, o.Payload)
}
...
func (o *VerifyAsyncOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.AssetOrder)
