...
func (o *UpdateTagsAsyncOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/Assets/{assetId}/tags][%d] updateTagsAsyncOK ", 200)
}

func (o *UpdateTagsAsyncOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
