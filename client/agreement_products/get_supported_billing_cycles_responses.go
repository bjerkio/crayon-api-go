...
func (o *GetSupportedBillingCyclesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetSupportedBillingCyclesOK()
...
func NewGetSupportedBillingCyclesOK() *GetSupportedBillingCyclesOK {
	return &GetSupportedBillingCyclesOK{}
}
...
func (o *GetSupportedBillingCyclesOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/AgreementProducts/{partNumber}/supportedbillingcycles][%d] getSupportedBillingCyclesOK  %+v", 200, o.Payload)
}
...
func (o *GetSupportedBillingCyclesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
