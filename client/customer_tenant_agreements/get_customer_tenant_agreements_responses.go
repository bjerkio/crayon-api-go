...
func (o *GetCustomerTenantAgreementsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCustomerTenantAgreementsOK()
...
func NewGetCustomerTenantAgreementsOK() *GetCustomerTenantAgreementsOK {
	return &GetCustomerTenantAgreementsOK{}
}
...
func (o *GetCustomerTenantAgreementsOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/customertenants/{customerTenantId}/agreements][%d] getCustomerTenantAgreementsOK  %+v", 200, o.Payload)
}
...
func (o *GetCustomerTenantAgreementsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.APICollectionOfServiceAccountAgreement)
