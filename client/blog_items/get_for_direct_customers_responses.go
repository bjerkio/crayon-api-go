...
func (o *GetForDirectCustomersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetForDirectCustomersOK()
...
func NewGetForDirectCustomersOK() *GetForDirectCustomersOK {
	return &GetForDirectCustomersOK{}
}
...
func (o *GetForDirectCustomersOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/BlogItems][%d] getForDirectCustomersOK  %+v", 200, o.Payload)
}
...
func (o *GetForDirectCustomersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.APICollectionOfBlogItem)
