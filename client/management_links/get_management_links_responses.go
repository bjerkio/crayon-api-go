...
func (o *GetManagementLinksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetManagementLinksOK()
...
func (o *GetManagementLinksOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/ManagementLinks][%d] getManagementLinksOK  %+v", 200, o.Payload)
}

func (o *GetManagementLinksOK) GetPayload() *models.APICollectionOfManagementLink {
	return o.Payload
}

func (o *GetManagementLinksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.APICollectionOfManagementLink)
