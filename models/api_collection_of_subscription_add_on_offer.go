...
func (m *APICollectionOfSubscriptionAddOnOffer) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfSubscriptionAddOnOffer) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfSubscriptionAddOnOffer) UnmarshalBinary(b []byte) error {
	var res APICollectionOfSubscriptionAddOnOffer
