...
func (m *APICollectionOfProductContainer) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfProductContainer) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfProductContainer) UnmarshalBinary(b []byte) error {
	var res APICollectionOfProductContainer
