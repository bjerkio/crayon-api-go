...
func (m *APICollectionOfSubscriptionResourceGroupUsageCost) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfSubscriptionResourceGroupUsageCost) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfSubscriptionResourceGroupUsageCost) UnmarshalBinary(b []byte) error {
	var res APICollectionOfSubscriptionResourceGroupUsageCost
