...
func (m *APICollectionOfSubscriptionConversion) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfSubscriptionConversion) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfSubscriptionConversion) UnmarshalBinary(b []byte) error {
	var res APICollectionOfSubscriptionConversion
