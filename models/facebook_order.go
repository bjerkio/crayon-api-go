...
func (m *FacebookOrder) validateLines(formats strfmt.Registry) error {
...
func (m *FacebookOrder) validateSubscriptionStartDate(formats strfmt.Registry) error {
