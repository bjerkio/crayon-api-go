...
func (m *APICollectionOfManagementLinkGrouped) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfManagementLinkGrouped) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfManagementLinkGrouped) UnmarshalBinary(b []byte) error {
	var res APICollectionOfManagementLinkGrouped
