...
func (m *APICollectionOfServiceAccountAgreement) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfServiceAccountAgreement) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfServiceAccountAgreement) UnmarshalBinary(b []byte) error {
	var res APICollectionOfServiceAccountAgreement
