...
func (m *APICollectionOfOrganizationAccess) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfOrganizationAccess) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfOrganizationAccess) UnmarshalBinary(b []byte) error {
	var res APICollectionOfOrganizationAccess
