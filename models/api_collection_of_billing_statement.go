...
func (m *APICollectionOfBillingStatement) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfBillingStatement) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfBillingStatement) UnmarshalBinary(b []byte) error {
	var res APICollectionOfBillingStatement
