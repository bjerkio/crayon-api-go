...
func (m *APICollectionOfOrganizationUsageCost) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfOrganizationUsageCost) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfOrganizationUsageCost) UnmarshalBinary(b []byte) error {
	var res APICollectionOfOrganizationUsageCost
