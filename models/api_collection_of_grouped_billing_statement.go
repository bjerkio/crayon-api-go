...
func (m *APICollectionOfGroupedBillingStatement) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfGroupedBillingStatement) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfGroupedBillingStatement) UnmarshalBinary(b []byte) error {
	var res APICollectionOfGroupedBillingStatement
