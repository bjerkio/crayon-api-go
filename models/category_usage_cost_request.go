...
func (m *CategoryUsageCostRequest) validateFrom(formats strfmt.Registry) error {
...
func (m *CategoryUsageCostRequest) validateTo(formats strfmt.Registry) error {
...
func (m *CategoryUsageCostRequest) UnmarshalBinary(b []byte) error {
	var res CategoryUsageCostRequest
