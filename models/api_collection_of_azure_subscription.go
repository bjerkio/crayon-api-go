...
func (m *APICollectionOfAzureSubscription) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfAzureSubscription) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfAzureSubscription) UnmarshalBinary(b []byte) error {
	var res APICollectionOfAzureSubscription
