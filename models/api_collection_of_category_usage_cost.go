...
func (m *APICollectionOfCategoryUsageCost) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfCategoryUsageCost) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfCategoryUsageCost) UnmarshalBinary(b []byte) error {
	var res APICollectionOfCategoryUsageCost
