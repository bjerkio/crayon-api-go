...
func (m *APICollectionOfSubcategoryUsageCost) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfSubcategoryUsageCost) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfSubcategoryUsageCost) UnmarshalBinary(b []byte) error {
	var res APICollectionOfSubcategoryUsageCost
