...
func (m *APICollectionOfResourceGroupUsageCost) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APICollectionOfResourceGroupUsageCost) validateItems(formats strfmt.Registry) error {
...
func (m *APICollectionOfResourceGroupUsageCost) UnmarshalBinary(b []byte) error {
	var res APICollectionOfResourceGroupUsageCost
